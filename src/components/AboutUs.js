    ...
    <div style={MainSectionStyle}>
      <div style={aboutSectionStyle}>
        ...
        <div style={textContainerStyle}>
          ...
          >
            <a
              href="https://github.com/Cyrus748"
              style={linkStyle}
              onMouseOver={onMouseOver}
              onMouseOut={onMouseOut}
            >
              - Made By Aditya Negi ❣️
            </a>
          </motion.div>
        </div>
      </div>
